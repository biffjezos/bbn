...
(function () {
  ...
  function mapZoom()    { var v = localStorage.getItem(PREF_MAP_ZOOM); return v !== null ? parseInt(v, 10) : 17; }
  function showFavPins() { return localStorage.getItem(PREF_FAV_PINS) !== 'false'; }
  ...
  var _orig = window.Auth && window.Auth.onLogin;
  if (window.Auth) {
